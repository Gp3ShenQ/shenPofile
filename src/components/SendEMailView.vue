<template>
  <template v-if="sendEmailStatus">
    <div class="top-0 left-0 z-20 fixed bg-black/40 p-5 w-full h-full" @click="closeSendEmail"></div>
    <div class="fixed top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 flex z-30 justify-center items-center min-w-[600px]">
